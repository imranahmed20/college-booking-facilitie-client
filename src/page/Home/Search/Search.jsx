    ...
    return (
        <div className='p-4 md:mx-80'>
            <form action="/search" method="get" className="flex">
                ...
                <button type="submit" className="px-4 py-2 bg-blue-500 text-white rounded-r-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400">Search</button>
            </form>
